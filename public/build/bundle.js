...
var app = (function () {
    ...
    const file$7 = "src\\components\\FeedbackStats.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	let h41;
    	let t3;
    	let t4_value = Math.round(/*average*/ ctx[0]) + "";
    	let t4;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			add_location(h40, file$7, 8, 4, 240);
    			add_location(h41, file$7, 9, 4, 270);
    			attr_dev(div, "class", "feedback-stats svelte-g12x9c");
    			add_location(div, file$7, 7, 0, 206);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*average*/ 1 && t4_value !== (t4_value = Math.round(/*average*/ ctx[0]) + "")) set_data_dev(t4, t4_value);
    		},
    		i: noop,
    		o: noop,
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-1qdr5kb");
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div, "class", "num-display svelte-19zxv7n");
    			add_location(div, file$5, 13, 4, 318);
    			attr_dev(button, "class", "close svelte-19zxv7n");
    			add_location(button, file$5, 17, 4, 386);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$5, 18, 4, 463);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    const file$4 = "src\\components\\FeedbackList.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$4, 21, 4, 526);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$3 = "src\\components\\RatingSelect.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-1vkw0eg");
    			add_location(input0, file$3, 15, 6, 308);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-1vkw0eg");
    			add_location(label0, file$3, 16, 6, 416);
    			attr_dev(li0, "class", "svelte-1vkw0eg");
    			add_location(li0, file$3, 14, 4, 296);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-1vkw0eg");
    			add_location(input1, file$3, 19, 6, 472);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-1vkw0eg");
    			add_location(label1, file$3, 20, 6, 580);
    			attr_dev(li1, "class", "svelte-1vkw0eg");
    			add_location(li1, file$3, 18, 4, 460);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-1vkw0eg");
    			add_location(input2, file$3, 23, 6, 636);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-1vkw0eg");
    			add_location(label2, file$3, 24, 6, 744);
    			attr_dev(li2, "class", "svelte-1vkw0eg");
    			add_location(li2, file$3, 22, 4, 624);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-1vkw0eg");
    			add_location(input3, file$3, 27, 6, 800);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-1vkw0eg");
    			add_location(label3, file$3, 28, 6, 908);
    			attr_dev(li3, "class", "svelte-1vkw0eg");
    			add_location(li3, file$3, 26, 4, 788);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-1vkw0eg");
    			add_location(input4, file$3, 31, 6, 964);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-1vkw0eg");
    			add_location(label4, file$3, 32, 6, 1072);
    			attr_dev(li4, "class", "svelte-1vkw0eg");
    			add_location(li4, file$3, 30, 4, 952);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-1vkw0eg");
    			add_location(input5, file$3, 35, 6, 1128);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-1vkw0eg");
    			add_location(label5, file$3, 36, 6, 1236);
    			attr_dev(li5, "class", "svelte-1vkw0eg");
    			add_location(li5, file$3, 34, 4, 1116);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-1vkw0eg");
    			add_location(input6, file$3, 39, 6, 1292);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-1vkw0eg");
    			add_location(label6, file$3, 40, 6, 1400);
    			attr_dev(li6, "class", "svelte-1vkw0eg");
    			add_location(li6, file$3, 38, 4, 1280);
    			...
    			attr_dev(input7, "class", "svelte-1vkw0eg");
    			add_location(input7, file$3, 43, 6, 1456);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-1vkw0eg");
    			add_location(label7, file$3, 44, 6, 1564);
    			attr_dev(li7, "class", "svelte-1vkw0eg");
    			add_location(li7, file$3, 42, 4, 1444);
    			...
    			attr_dev(input8, "class", "svelte-1vkw0eg");
    			add_location(input8, file$3, 47, 6, 1620);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-1vkw0eg");
    			add_location(label8, file$3, 48, 6, 1728);
    			attr_dev(li8, "class", "svelte-1vkw0eg");
    			add_location(li8, file$3, 46, 4, 1608);
    			...
    			attr_dev(input9, "class", "svelte-1vkw0eg");
    			add_location(input9, file$3, 51, 6, 1784);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-1vkw0eg");
    			add_location(label9, file$3, 52, 6, 1895);
    			attr_dev(li9, "class", "svelte-1vkw0eg");
    			add_location(li9, file$3, 50, 4, 1772);
    			attr_dev(ul, "class", "rating svelte-1vkw0eg");
    			add_location(ul, file$3, 13, 0, 271);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1g9y9lk"));
    			add_location(button, file$2, 6, 0, 125);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-1g9y9lk"))) {
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { style: 0, type: 1, disabled: 2 });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-ynpqpy");
    			add_location(div, file$1, 57, 12, 1555);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-ynpqpy");
    			add_location(h2, file$1, 45, 8, 1106);
    			attr_dev(header, "class", "svelte-ynpqpy");
    			add_location(header, file$1, 44, 4, 1088);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us something");
    			attr_dev(input, "class", "svelte-ynpqpy");
    			add_location(input, file$1, 52, 12, 1333);
    			attr_dev(div, "class", "input-group svelte-ynpqpy");
    			add_location(div, file$1, 51, 8, 1294);
    			add_location(form, file$1, 48, 4, 1178);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 7, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
